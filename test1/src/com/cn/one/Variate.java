...
//		}
		...
		//输出顺序2*3  2*3  2*3  41 2*3 2*3 2*3 4 12*3 2*3 2*34
//		for(int a=0;a<3;a++){
//			//System.out.print("1");
//			for(int b=0;b<3;b++){
//				//System.out.print("2");
...
//		int a=input.nextInt();
//		System.out.println("千分位："+a/1000);
//		System.out.println("百分位:"+a/100%10);
//		System.out.println("十分位:"+a/10%10);
